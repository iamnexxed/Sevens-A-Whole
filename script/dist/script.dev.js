...
var degree = 0; // document.getElementById()

document.addEventListener('keydown', RotateImage); // document.addEventListener('onmouseover', GetImage);
...
function RotateImage(event) {
  ...
  console.log(image[2]); // while (event.key == "ArrowLeft" || event.key == "ArrowRight")

  {
    if (event.key == "ArrowLeft" || event.key == "A" || event.key == "a") {
      ...
      if (image[2].id == "mydivone") {
        ...
        console.log("Rotate 5 Left"); // break;
      ...
      if (image[2].id == "mydivone") {
        ...
        degreeRot[4] += 15;
        image[2].style.transform = 'rotate(' + degreeRot[4] + 'deg)';
        console.log("Rotate 5 Right"); // break;
      } else if (image[2].id == "mydivsix") {
        degreeRot[5] += 15;
        image[2].style.transform = 'rotate(' + degreeRot[5] + 'deg)';
        console.log("Rotate Left"); // break;
